...
// console.log(canWeDeliver(deliveryAreaZipCodes, 85205))
...
let deals2 = deals + deals[0].title.replace('15', '10')
...
let deals3 = deals + deals[1].desc.replace('March', 'April')
